...
public function show(Location $location): JsonResponse
{
    ...
    return new JsonResponse([
        ...
        'superficie' => $location->getSuperficie(),
        'adresse' => $location->getAdresse(),
        'description' => $location->getDescription(),
        'disponibilite' => $location->isDisponibilite(),
        'meuble' => $location->isMeuble()
    ]);
}
...
public function addPhotos(Location $location, Request $request): JsonResponse
{
    ...
    #[Route('/api/locations/{id}', name: 'api_location_show', methods: ['GET'])]
public function afficher(int $id, LocationRepository $locationRepository): JsonResponse
{
...
#[Route('/api/locations/search', name: 'api_location_search', methods: ['GET'])]
public function search(Request $request, LocationRepository $repository): JsonResponse
{
    ...
    $locations = $repository->findByVille($ville);
